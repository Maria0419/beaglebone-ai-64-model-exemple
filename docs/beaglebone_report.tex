...
For this project, the safe starting operator set was limited to \texttt{Conv} and \texttt{Relu}. In this case, the final ONNX graph also intentionally avoided operators such as \texttt{Resize}, \texttt{Upsample}, \texttt{ConvTranspose}, and \texttt{Sigmoid}. Sigmoid and threshold are applied in Python after inference. This keeps the model graph small and maximizes the chance that TIDL creates one fully offloaded subgraph.
